...
# Creamos la columna 'id' con la inicial de cada plataforma concatenado con la columna 'show_id'
...
# Unimos todos los archivos en un solo Dataframe
df_movies = pd.concat([df_Amazon, df_Disney,df_Hulu,df_Netflix])

# En la columna Rating reemplazamos los valores nulos por "G"
...
# Normalizamos el campo duration_type a singular
